...
print2log("===== NODE 1: Setup & Classification =====")
...
pdf_files = [f for f in custom_os.listdir(input_path) if f.lower().endswith(".pdf")]
...
xlsx_files = [f for f in custom_os.listdir(output_path) if f.lower().endswith(".xlsx")]
